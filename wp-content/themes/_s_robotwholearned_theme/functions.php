...
function _s_bootstrap_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( '_s_bootstrap_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // _s_bootstrap_setup
...
function _s_bootstrap_scripts() {
    ...
    wp_register_style( 'custom-styles-css', get_template_directory_uri() . '/custom-styles.css', array(), '0.0.1','all' );
